...
public class ProjectInfoOBJ extends TestBase {
	...
	public static By SIGNINBUTTON = By.xpath("//label[text()='Password']//parent::div//parent::form//button[text()='Sign In']");

	//public static By PROJECTSELECTION = By.xpath("//div[@class='card-body']/p[text()='99999']");
	//public static By PROJECTSELECTION = By.xpath("//div[@class='card-body']/p[text()='879697']");
//	public static By PROJECTSELECTION1 = By.xpath("//div[@class='card-body']/p[text()='123']");
	//public static By PROJECTSELECTION1 = By.xpath("//div[@class='card-body']/p[text()='8745']");
	public static By PROJECTSELECTIONWBS = By.xpath("//div[@class='card-body']/p[text()='DEVTEST123']");
	...
	public static By typeofFacilityDropDownValue= By.xpath ("//div[text()='Fertilizer']");
	...
	public static By leadOfficeDropDownValue= By.xpath ("//div[text()='Beijing']");
   ...
   //Piping DPS
	...
	public static By twoDDesingTextBox = By.xpath ("//div[@class=' css-1wa3eu0-placeholder' and contains(text(),'2D Design Software')]");
	public static By formInfo = By.xpath ("//div[@class='form-container ']");

	//create new project
	public static By btncreateProject= By.xpath("//button[text()='Create a Project']");
	public static By modeltitle = By.xpath("//div[@class='modal-content']//span[@class='bvModalTitle']");
	public static By inputProjectNumber= By.xpath("//div[@class='modal-content']//input[@name='projectNumber']");
	public static By inputProjectName= By.xpath("//div[@class='modal-content']//input[@name='projectName']");
	public static By btnCreate= By.xpath("//div[@class='modal-content']//button[@class='modalPrimaryButton btn btn-primary ']");
	public static By selectProjectCard= By.xpath("//p[text()='textToReplace']");
