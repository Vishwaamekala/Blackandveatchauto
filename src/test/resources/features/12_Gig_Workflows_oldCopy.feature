...
#      | Electrical Load List excluding Voltage Drop Calculations |
  ...
  Scenario Outline:Completed all the the five steps on Gig Worflow for IandC displaine
    ...
    And User selects Stepfour gigents checkbox and it validates all the selected values in Stepfive "<gigworkflow>","<submenus>" IandC
...
# Structural
  ...
  Scenario Outline:Completed all the the five steps on Gig Worflow for Structural displaine
    ...
    Examples:
      | gigworkflow                               | submenus                                               |
      | Secondary Structural Steel Design & Model | Issue for IHR,Address IHR Comments           |
      | Modules Structures Drawings               | Issue for Client Review,Address Client Review Comments |
